...
const names = () => {
  if (!validateParams([params.config]))
    return;
...
const exp = () => {
  if (!validateParams([params.fromConfig, params.fromCollection, params.toFile]))
    return;
...
const imp = () => {
  if (!validateParams([params.toConfig, params.toCollection, params.fromFile]))
    return;
...
const expimp = () => {
  if (!validateParams([params.fromConfig, params.toConfig, params.fromCollection, params.toCollection]))
    return;
